...
import com.wildan.newsapp.databinding.ItemCategoryBinding
import com.wildan.newsapp.model.CategoryModel

class CategoryAdapter (private val view: View) : ListAdapter<CategoryModel, CategoryAdapter.Holder>(
    MyDiffCallback()
) {
